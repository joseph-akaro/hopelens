        ...
        <SiteHeader />
            ...
            <div className="@container/main flex flex-1 flex-col gap-2">
                <div className="flex flex-col gap-4 p-4 md:gap-6 md:py-6">
                    ...
                    <ProjectCard imageUrl="/images/pe.jpg" title="Program Evaluation" shortdescription={"This project’s goal is to evaluate the top three programs (17 Stories, Stories of Hope and Lead Today)..."} countries={3} stage={"Reporting & Analysis"}/>
                    ...
                    <ProjectCard imageUrl="/images/ha.jpg" title="Final Third" shortdescription={"This project’s goal is to evaluate the top three programs (17 Stories, Stories of Hope and Lead Today)..."} countries={3} stage={"Planning"}/>
                    ...
                    <ProjectCard imageUrl="/images/cct.jpg" title="Equiping for Biblical Discipleship" shortdescription={"This project’s goal is to evaluate the top three programs (17 Stories, Stories of Hope and Lead Today)..."} countries={1} stage={"Planning"}/>
                    </div>
                </div>
            </div>
            </div>
